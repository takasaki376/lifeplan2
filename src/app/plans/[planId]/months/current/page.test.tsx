...
import MonthlyInputCurrentPage from "./page";
...
describe("MonthlyInputCurrentPage balance display", () => {
  ...
  it("shows balance when both income and expense are entered", async () => {
    ...
    const { container } = render(<MonthlyInputCurrentPage />);
  ...
  it("shows empty placeholder when either field is empty", async () => {
    ...
    await user.type(getIncomeInput(), "120000");
